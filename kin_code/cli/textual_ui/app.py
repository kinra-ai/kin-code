...
from kin_code.cli.textual_ui.widgets.approval_app import ApprovalApp
...
from kin_code.cli.textual_ui.widgets.welcome import WelcomeBanner
...
from kin_code.core.modes import AgentMode, next_mode
from kin_code.core.paths.config_paths import HISTORY_FILE
from kin_code.core.tools.base import BaseToolConfig, ToolPermission
from kin_code.core.types import ApprovalResponse, LLMMessage, Role
...
class KinApp(App):  # noqa: PLR0904
    ...
    def _set_tool_permission_always(
        ...
        if save_permanently:
            KinConfig.save_updates({"tools": {tool_name: {"permission": "always"}}})
    ...
    def _save_config_changes(self, changes: dict[str, str]) -> None:
        ...
        if updates:
            KinConfig.save_updates(updates)
...
"""
    ...
    async def _reload_config(self) -> None:
        try:
            new_config = KinConfig.load(**self._current_agent_mode.config_overrides)
...
def run_textual_ui(
    ...
    update_notifier = PyPIVersionUpdateGateway(project_name="kin-code")
