...
from kin_code.core.paths.global_paths import GLOBAL_CONFIG_FILE, TRUSTED_FOLDERS_FILE
...
class TrustFolderDialog(CenterMiddle):
    ...
    def compose(self) -> ComposeResult:
        with CenterMiddle(id="trust-dialog"):
            ...
            yield NoMarkupStatic(
                "Files that can modify your Kin Code setup were found here. Do you trust this folder?",
