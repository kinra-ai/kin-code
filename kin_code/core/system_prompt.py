...
from kin_code.core.paths.config_paths import INSTRUCTIONS_FILE
...
if TYPE_CHECKING:
    from kin_code.core.config import KinConfig, ProjectContextConfig
...
def _add_commit_signature() -> str:
    return (
        ...
        "It will always be suffixed with a line telling it was generated by Kin Code with the appropriate co-authoring information.\n"
        "The format you will always uses is the following heredoc.\n\n"
        "```bash\n"
        "git commit -m <Commit message here>\n\n"
        "Generated by Kin Code.\n"
        "Co-Authored-By: Kin Code <code@kinra.ai>\n"
        "```"
    )
