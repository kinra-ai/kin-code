...
class APIToolFormatHandler:
    ...
    def get_available_tools(
        self, tool_manager: ToolManager, config: KinConfig
    ) -> list[AvailableTool]:
    ...
    def resolve_tool_calls(
        self, parsed: ParsedMessage, tool_manager: ToolManager, config: KinConfig
    ) -> ResolvedMessage:
        resolved_calls = []
        failed_calls = []
