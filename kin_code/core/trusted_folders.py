...
from kin_code.core.paths.global_paths import TRUSTED_FOLDERS_FILE

TRUSTABLE_FILENAMES = ["AGENTS.md", "KIN.md", ".kin-code.md", "VIBE.md", ".vibe.md"]


def has_trustable_content(path: Path) -> bool:
    if (path / ".kin-code").exists():
        return True
