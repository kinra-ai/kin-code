...
async def test_do_update_returns_true_when_first_command_succeeds() -> None:
    ...
    with patch(
        "kin_code.cli.update_notifier.update.UPDATE_COMMANDS",
        [["cmd1", "arg1"], ["cmd2", "arg2"]],
    ):
        with patch(
            "kin_code.cli.update_notifier.update.asyncio.create_subprocess_exec"
        ) as mock_create:
            ...
            assert mock_create.call_args[0][0] == "cmd1"
...
async def test_do_update_returns_true_when_second_command_succeeds() -> None:
    ...
    with patch(
        ...
        with patch(
            ...
            assert mock_create.call_args_list[0][0][0] == "cmd1"
            assert mock_create.call_args_list[1][0][0] == "cmd2"
